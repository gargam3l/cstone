<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('cstoneApp.customer.home.title')" id="customer-heading">Customers</span>
            <router-link :to="{name: 'CustomerCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-customer">
                ...
                <span  v-text="$t('cstoneApp.customer.home.createLabel')">
        ...
        <div class="alert alert-warning" v-if="!isFetching && customers && customers.length === 0">
            <span v-text="$t('cstoneApp.customer.home.notFound')">No customers found</span>
        </div>
        <div class="table-responsive" v-if="customers && customers.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('cstoneApp.customer.company')">Company</span></th>
                    <th><span v-text="$t('cstoneApp.customer.address')">Address</span></th>
                    <th><span v-text="$t('cstoneApp.customer.personId')">Person Id</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
                <tr v-for="customer in customers"
                    ...
                    <td>
                        <div v-if="customer.personId">
                            <router-link :to="{name: 'PersonView', params: {personId: customer.personId.id}}">{{customer.personId.id}}</router-link>
                        </div>
                    </td>
                    <td class="text-right">
                        <div class="btn-group">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="cstoneApp.customer.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-customer-heading" v-text="$t('cstoneApp.customer.delete.question', {'id': removeId})">Are you sure you want to delete this Customer?</p>
            </div>
