    ...
    <b-navbar toggleable="md" type="dark" class="bg-primary">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">cstone</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/incident">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.incident')">Incident</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/group">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.group')">Group</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/incident-worklog">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.incidentWorklog')">IncidentWorklog</span>
                    </b-dropdown-item>
