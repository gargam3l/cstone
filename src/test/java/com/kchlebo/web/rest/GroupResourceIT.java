...
import com.kchlebo.domain.Group;
import com.kchlebo.repository.GroupRepository;
...
public class GroupResourceIT {
    ...
    public void createGroup() throws Exception {
        ...
        assertThat(testGroup.getEmail()).isEqualTo(DEFAULT_EMAIL);
    }
    ...
    public void updateGroup() throws Exception {
        ...
        assertThat(testGroup.getEmail()).isEqualTo(UPDATED_EMAIL);
    }
